/* 
Created separate component for this, since a lot of logic is needed for the three buttons 
*/

import { IconStar } from "./rateTrip/CreateRating";

/* Omg trip needs to store more data, average rating and number of ratings */
  ...
  return (
    <div className="flex flex-row items-center justify-center gap-20">
      ...
      <div className="flex flex-row items-center gap-2 group">
        <div className="w-8 h-8 rounded-full group-hover:bg-sky-300 bg-opacity-0 flex items-center justify-center">
          <IconComment className="group-hover:bg-sky-300 group-hover:text-sky-900 " />
        </div>
        <div className="group-hover:text-sky-900">{numberOfRatings}</div>
      </div>

      <div className="flex flex-row items-center gap-2 group">
        <div className="w-8 h-8 rounded-full group-hover:bg-red-500 flex items-center justify-center">
          <IconHeart className="group-hover:bg-red-500 bg-opacity-10" />
        </div>
        <div className="group-hover:text-sky-700">{averageRating}</div>
      </div>
...
function IconHeart({ className }: { className: string }) {
  return (
    <svg className={className} viewBox="0 0 1024 1024" fill="currentColor" height="1em" width="1em">
