...
export default function CreateTripPage() {
  ...
  const validPrice =
    /^$?-?([1-9]{1}[0-9]{0,2}(,d{3})*(.d{0,2})?|[1-9]{1}d{0,}(.d{0,2})?|0(.d{0,2})?|(.d{1,2}))$|^-?$?([1-9]{1}d{0,2}(,d{3})*(.d{0,2})?|[1-9]{1}d{0,}(.d{0,2})?|0(.d{0,2})?|(.d{1,2}))$|^($?([1-9]{1}d{0,2}(,d{3})*(.d{0,2})?|[1-9]{1}d{0,}(.d{0,2})?|0(.d{0,2})?|(.d{1,2})))$/.test(
      price
    );
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <label>
              <InputWithValidation
                ...
                explanation={
                  !validPrice ? "Please enter the price of the trip in $" : ""
                }
              />
            </label>
