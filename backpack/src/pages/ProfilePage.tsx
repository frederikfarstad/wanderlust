    ...
    return (
      <div className="grid smallScreen:grid-cols-1 grid-cols-3 h-screen bg-primary-300 overflow-scroll">
        <div id="gridOneProfile" className="h-screen">
            <div className="rounded-full overflow-hidden w-1/2 aspect-square m-auto mb-[5vh] mt-[10vh] bg-gradient-to-br from-[#E54B4B] to-[#FFA987] p-2">
            ...
            <div className="m-auto w-3/4 text-white">
                ...
                <div className="bg-gradient-to-br from-[#E54B4B] to-[#FFA987] rounded-3xl">
